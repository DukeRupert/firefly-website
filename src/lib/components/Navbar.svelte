		...
		>
			...
			<div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
				...
				{#if login}
					<a
						href={login}
						class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-background bg-gradient-to-r from-background to-secondary-600 hover:from-background hover:to-background"
						>Log in</a
					>
				{/if}
			</div>
	...
	>
		...
		>
				...
				<div class="border-t border-gray-700 pt-4 pb-3">
					<div class="flex justify-center space-x-6">
						{#each COMPANY.social as { type, href }}
							{#if type == 'facebook'}
								<a {href} class="text-gray-700 hover:text-gray-800 rounded-md hover:bg-gray-100">
			...
			{#if login}
				<a
					href={login}
					class="block w-full px-5 py-3 text-center font-medium capitalize text-background bg-gradient-to-r from-background to-secondary-600 hover:from-background hover:to-background"
				>
					Log in
				</a>
			{/if}
